...
if __name__ == "__main__":
    jatos_data_path = "experiments/category_targeting/expt2_raw_data.jsonl"
    ...
    target_data_path = "experiments/category_targeting/expt2.h5"
    ...
    successful_targetting = np.logical_and(targetting_condition, category_ids == rec_categoryids[:, :6])
